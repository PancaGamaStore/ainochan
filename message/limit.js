...
exports.isLimit = function(sender, isPremium, isCreator, limitCount, _db){
    ...
    if (found === false) {
        ...
        _db.push(obj)
        fs.writeFileSync('./database/users/limit.json', JSON.stringify(_db))
        return false
    }
}
...
exports.addBalance = function(sender, duit, _db){
    ...
    if (position !== false) {
        ...
        fs.writeFileSync('./database/users/balance.json', JSON.stringify(_db))
    } else {
        var bulin = ({
            id: sender,
            balance: duit
...
exports.isGame = function(sender, isCreator, gcount, _db){
    ...
    if (found === false){
        ...
        _db.push(obj);
        fs.writeFileSync('./database/users/glimit.json',JSON.stringify(_db));
        return false;
    }
}
...
exports.createHit = function(sender, _db){
    ...
    _db.push(anohoh);
    fs.writeFileSync('./database/users/userhit.json',JSON.stringify(_db));''
